...
Whilst SNAP is focused on encoding/decoding structs and arrays, @tabularelf has `ds_*` conversion scripts available [in a gist](https://gist.github.com/tabularelf/547b62efbcb0beaa8e6478afae8e693f). TabularElf has also made a [TOML parser](https://github.com/tabularelf/TabTomlParser/).
