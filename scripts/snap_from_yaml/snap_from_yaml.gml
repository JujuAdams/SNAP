...
function __snap_from_yaml_parser(_buffer, _buffer_size, _base_indent)
{
    ...
    while(buffer_tell(_buffer) < _buffer_size)
    {
        ...
        else
        {
            ...
            buffer_seek(_buffer, buffer_seek_relative, -1);
            _result = __snap_from_yaml_scalar(_buffer, _buffer_size, _indent);
            break;
        }
    }
...
function __snap_from_yaml_scalar(_buffer, _buffer_size, _base_indent)
{
    var _result = undefined;
...
function __snap_from_yaml_struct(_buffer, _buffer_size, _base_indent)
{
}