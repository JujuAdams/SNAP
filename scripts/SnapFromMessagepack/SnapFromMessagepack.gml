...
function SnapFromMessagepack(_buffer, _offset)
{
...
function __SnapFromMessagepackValue(_buffer)
{
    ...
    else switch(_byte)
    {
        ...
        case 0xc1: /*192*/ show_debug_message("SnapFromMessagepack(): Warning! Datatype 0xC1 found, but this value should never be used"); break; //Baby shoes for sale, never worn
        ...
        default:
            show_debug_message("SnapFromMessagepack(): Warning! Unsupported datatype " + string(_byte) + " found");
        break;
    }
}
