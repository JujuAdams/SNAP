...
function SnapToConfigJSON(_ds, _pretty = false, _alphabetise = false, _accurateFloats = false)
{
    var _buffer = buffer_create(1024, buffer_grow, 1);
    SnapBufferWriteConfigJSON(_buffer, _ds, _pretty, _alphabetise, _accurateFloats);
