...
function SnapBufferReadQML(_buffer, _constructorDict, _inOffset = undefined)
{
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            __SnapBufferReadQMLComment(_buffer, _bufferSize);
        }
        else if ((_byte == ord("/")) && (buffer_peek(_buffer, buffer_tell(_buffer), buffer_u8) == ord("*")))
        {
            __SnapBufferReadQMLMultilineComment(_buffer, _bufferSize);
        }
        else if (_byte == ord("["))
        {
            _result = __SnapBufferReadQMLArray(_buffer, _bufferSize);
        }
        else if (_byte == ord("{"))
        {
            _result = __SnapBufferReadQMLStruct(_buffer, _bufferSize);
        }
        else if (_byte > 0x20)
        {
...
function __SnapBufferReadQMLArray(_buffer, _bufferSize)
{
    var _result = [];
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            var _value = __SnapBufferReadQMLValue(_buffer, _bufferSize, _byte);
...
function __SnapBufferReadQMLStruct(_buffer, _bufferSize)
{
    var _result = {};
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            var _key = __SnapBufferReadQMLValue(_buffer, _bufferSize, _byte);
...
function __SnapBufferReadQMLValue(_buffer, _bufferSize, _firstByte)
{
    if (_firstByte == ord("["))
    {
        return __SnapBufferReadQMLArray(_buffer, _bufferSize);
    }
    else if (_firstByte == ord("{"))
    {
        return __SnapBufferReadQMLStruct(_buffer, _bufferSize);
    }
    else if (_firstByte == ord("\""))
    {
        return __SnapBufferReadQMLDelimitedString(_buffer, _bufferSize);
    }
    else
    {
        return __SnapBufferReadQMLString(_buffer, _bufferSize);
    }
}

function __SnapBufferReadQMLDelimitedString(_buffer, _bufferSize)
{
...
function __SnapBufferReadQMLString(_buffer, _bufferSize)
{
    static _cacheBuffer = buffer_create(1024, buffer_grow, 1);
    buffer_seek(_cacheBuffer, buffer_seek_start, 0);
...
function __SnapBufferReadQMLComment(_buffer, _bufferSize)
{
    while(buffer_tell(_buffer) < _bufferSize)
    {
        var _byte = buffer_read(_buffer, buffer_u8);
...
function __SnapBufferReadQMLMultilineComment(_buffer, _bufferSize)
{
    while(buffer_tell(_buffer) < _bufferSize)
    {
        var _byte = buffer_read(_buffer, buffer_u8);
